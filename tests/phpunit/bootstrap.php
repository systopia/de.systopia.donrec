...
// Make CRM_Donrec_ExtensionUtil available.
require_once __DIR__ . '/../../donrec.civix.php';
...
addExtensionToClassLoader($loader, 'de.systopia.donrec');
 ...
 */
function _donrec_test_civicrm_container(ContainerBuilder $container): void {
}
